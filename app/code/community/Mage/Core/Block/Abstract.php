...
abstract class Mage_Core_Block_Abstract extends Varien_Object
{
    ...
    protected function _saveCache($data)
    {
        ...
        /*
         * Fixing bug in core: each cacheable block should be also tagged with tags from all its children blocks
         * to allow to refresh it if child block content was changed.
         * Mainly a problem for cms static blocks embedded into standard magento blocks which then aren't automatically
         * refreshed when cms static block is saved from backend.
         */
        /** @var Mage_Core_Block_Abstract $childBlock */
        foreach ($this->getChild() as $childBlock) {
            $tags = array_merge($tags, $childBlock->getCacheTags());
        }
